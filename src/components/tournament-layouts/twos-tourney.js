        ...
        >
          ...
          <Row>
            <Col className="m-5">
              ...
              <ul>
                <li>
                  Find a partner within the clan (Or risk it with a random)
                </li>
                <li>
                  Each team will be assigned a TEAM NUMBER (don't forget this
                  lol)
                </li>
              ...
              <ul>
                ...
                <li>
                  If you do not care who you teammate is, then leave it empty.
                  We will randomly assign one
                </li>
              </ul>
              ...
              <ul>
                <li>
                  We will use a Random Number Generator to assign each team a
                  number
                </li>
              ...
              <ul>
                <li>
                  Since it is a best of 3 for each matchup, we will have all
                  teams play concurrently for each round
                </li>
                <li>
                  After all teams have finished their BO3, then we will proceed
              ...
              <ul>
                ...
                <li>Runner up team gets $30 dollars</li>
              ...
              <h6 className="ml-3">
                The gift cards will be purchased on amazon as an e-gift card. It
                will need an email address as the recipient.
              </h6>
              <h6 className="ml-3">
                LET US KNOW IF YOU ARE NOT FROM USA, because itunes giftcards
                are per country basis.
              </h6>
              <h6 className="ml-3">
                LET US KNOW IF YOU HAVE ANDROID, because itunes giftcards will
                be a book placeholder.
              </h6>
              <h6 className="ml-3">
                If you won a reward, just give us a email you have access to
              </h6>
              <h6 className="ml-3">
                ** We have recently introduced Paypal and Venmo as options **
              </h6>
            </Col>
          </Row>
          <Row>
            <Col>
              ...
              <iframe
                title="December"
                src="https://docs.google.com/forms/d/e/1FAIpQLSfmUbvQha_bp17OA8EUROxHg8pZgUXOvfwpTwa17tUizv_DNw/viewform?embedded=true"
                width="100%"
                height="1950"
                frameBorder="0"
                marginheight="0"
