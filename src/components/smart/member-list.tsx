...
export const MemberList = async ({ members }: { members: any[] }) => {
  const fetchMemberDetails = members.map(async (member) => {
                ...
                <Grid container>
                  ...
                  <Grid size={{ xs: 12, md: 6 }}>
                    ...
                    <Typography variant="body1">
                      Current Season: League {member.innerRight.currentPathOfLegendSeasonResult?.leagueNumber || 0}
                    </Typography>
                    <Typography variant="body1">
                      Last Season: League {member.innerRight.lastPathOfLegendSeasonResult?.leagueNumber || 0}
                    </Typography>
                    <Typography variant="body1">
                      Best Season: League {member.innerRight.bestPathOfLegendSeasonResult?.leagueNumber || 0}
                    </Typography>
